...
const ImageSlider = ({ sliderProps }: { sliderProps: ImageSliderProps[] }) => {
    ...
    return (
        <>
            <div
                className={`relative flex h-[36rem] flex-col items-center justify-center overflow-x-hidden overflow-y-hidden bg-blend-darken`}
            >
                <img
                ...
                />
                <div
                    className={`text-md absolute left-1/2 top-[80%] flex w-[45%] -translate-x-1/2 transform items-center justify-between space-x-5 rounded-lg bg-gray-100 p-3 text-black`}
                >
